        ...
        <div class="row">
            <div class="col-lg-4 bg-dark text-white text-center py-4">
                <div class="header-left">
                    ...
                    <h3 class="display-6" id="name"><?php echo $regNo ?></h3>
                    ...
                    <ul class="list-unstyled text-white-50 ml-5 py-2 text-center">
                        ...
                        <li class="list-item" style="text-align: left;">
                            ...
                            <?php 
                                echo
                                "
                                <a href='mailto:$row[email]' target=_blank>$email </a>
                                "; 
            ...
            <div class="col-lg-8 bg-light text-dark py-5 px-5">
                ...
                <div>
                    ...
                    <ul class="ex-list">
                        <?php
                            $q="SELECT title,company_name,duration,description FROM work_experience WHERE regNo='$regNo'";
                    ...
                    <?php
                        ...
                        ";
                        $q="SELECT project_link,project_description FROM project_details WHERE regNo='$regNo'";
                        $result=mysqli_query($conn,$q);
                        while($row=mysqli_fetch_row($result)){
                            echo
                            "
